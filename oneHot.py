import gym
import numpy as np
# Source: https://stackoverflow.com/questions/54022606/openai-gym-how-to-create-one-hot-observation-space


class OneHotEncoding(gym.Space):  # create one hot vector
    """
    {0,...,1,...,0}
